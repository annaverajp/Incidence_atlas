...
tab1 <- read_excel("myapp/data/Table1.xlsx") 

Table_all <- read.csv("myapp/data/Table_all.csv", colClasses = c("NULL", NA, NA, NA, NA, NA, NA, NA))
Copenhagen_all <- read.csv("myapp/data/Copenhagen_all.csv", colClasses = c("NULL", NA, NA, NA, NA, NA, NA))

Table_CD <- read.csv("myapp/data/Table_CD.csv", colClasses = c("NULL", NA, NA, NA, NA, NA, NA))
Copenhagen_CD <- read.csv("myapp/data/Copenhagen_CD.csv", colClasses = c("NULL", NA, NA, NA, NA, NA, NA, NA))

Table_NCD <- read.csv("myapp/data/Table_NCD.csv", colClasses = c("NULL", NA, NA, NA, NA, NA, NA))
Copenhagen_NCD <- read.csv("myapp/data/Copenhagen_NCD.csv", colClasses = c("NULL", NA, NA, NA, NA, NA, NA, NA))


source("myapp/data/Chapters.R")
